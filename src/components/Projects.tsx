          ...
          <div className="text-center space-y-4">
            ...
            <div className="flex gap-4 justify-center">
              <button
                ...
                className="p-3 bg-blue-600 rounded-full text-white hover:bg-blue-500 transition-all duration-200 hover:scale-110 will-change-transform"
              >
                <ExternalLink size={20} />
              </button>
              <button
                className="p-3 bg-white/20 backdrop-blur-sm rounded-full text-white hover:bg-white/30 hover:scale-105 transition-all duration-200 will-change-transform"
                onClick={(e) => {
                  e.stopPropagation();
